...
//    Login loginToRegister = new Login();
    ...
    private static String _pathToStorageFile = "/doc/UserData.csv";
    ...
    public void handleLoginButton(ActionEvent event) throws IOException {
        ...
        if ((user.equals("") && pass.equals( "" ))) {
            ...
            OutputLabel.setText( "Please check username and password" );
        }else if (user.equals("")){
...
//========================READ FILES===================================================
    ...
    private void openWindow()
    {
        ...
        Parent window1;
        try {
            window1 = FXMLLoader.load(getClass().getResource( "/main/FXML/HomeScreen.fxml" ));
